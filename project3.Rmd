...
According to the bar plot above, The weekday published articles drives the total number of published articles. Also, A large proportion of articles have 10 keywords in the metadata. It seems more keywords is beneficial for article search, which could result in higher sales.  
...
g + geom_point()
  #labs( title = "Boxplot for shares for different number of keywords") + 
  #geom_point(aes(color = is_weekend ),position = "jitter") 
```